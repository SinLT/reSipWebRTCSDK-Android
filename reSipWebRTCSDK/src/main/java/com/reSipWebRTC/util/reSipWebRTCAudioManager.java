 ...
 */
public class reSipWebRTCAudioManager {
  ...
  private reSipWebRTCProximitySensor proximitySensor = null;
  ...
  /** Construction */
  public static reSipWebRTCAudioManager create(Context context,
                                   Runnable deviceStateChangeListener) {
    return new reSipWebRTCAudioManager(context, deviceStateChangeListener);
  }

  private reSipWebRTCAudioManager(Context context,
                             Runnable deviceStateChangeListener) {
   ...
   // useSpeakerphone = sharedPreferences.getString(context.getString(R.string.pref_speakerphone_key),
    ...
    proximitySensor = reSipWebRTCProximitySensor.create(context, new Runnable() {
    ...
    reSipWebRTCRTCUtils.logDeviceInfo(TAG);
  }
  ...
  public void setAudioDevice(AudioDevice device) {
    ...
    reSipWebRTCRTCUtils.assertIsTrue(audioDevices.contains(device));
  ...
  private void registerForWiredHeadsetIntentBroadcast() {
    ...
    wiredHeadsetReceiver = new BroadcastReceiver() {
      ...
      public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG, "BroadcastReceiver.onReceive" + reSipWebRTCRTCUtils.getThreadInfo()
                + ": "
                + "a=" + intent.getAction()
  ...
  private void onAudioManagerChangedState() {
    ...
    if (audioDevices.size() == 2) {
      reSipWebRTCRTCUtils.assertIsTrue(audioDevices.contains(AudioDevice.EARPIECE)
