...
public class CallActivity extends AppCompatActivity implements SipCallConnectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("=============onCreate call_id=======:" + call_id);
    ...
    private void startCall()
    {
        ...
        if (callDirection == Contacts.INVITE_VIDEO_REQUEST) {
            ...
            callParams.setAgcControlLevel(1);
            callParams.setAgcControlGain(20);
            PhoneService.instance().call(peer_number, callParams);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.button_hangup) {
            ...
            if (call_id > 0) {
                ...
                System.out.println("=============button_hangup call_id=======:" + call_id);
            ...
            if (call_id > 0) {
                ...
                btnAnswer.setVisibility(View.INVISIBLE);
                btnAnswerAudio.setVisibility(View.INVISIBLE);
                PhoneService.instance().getCallParams(call_id).setAudioCodec("PCMA");
...
//                    PhoneService.instance().setMicrophoneMute(call_id, false);
    ...
    public void onCallConnected(int call_id) {
        ...
        System.out.println("==============onCallConnected:" + call_id);
